...
using Microservice.Service.UserService.API.Swagger;
...
using ServiceMapperProfile = Microservice.Service.UserService.API.Mapper.ServiceMapperProfile;

namespace Microservice.Service.UserService.API
{
